    ...
    $(".user-add-new-contact").bind("click", function() {
        ...
        $.post("/contact/add-new", {uid: targetId}, function(data) {
            if(data.success) {
                ...
                increaseNumberNotifContact("count-request-contact-sent"); // js/caculateNotifiContacts.js
...
socket.on("response-add-new-contact", function(user)  {
    ...
    increaseNumberNotifContact("count-request-contact-received"); // js/caculateNotifiContacts.js

    increaseNumberNotification("noti_contact_counter", 1); // js/caculateNotification.js
    increaseNumberNotification("noti_counter", 1); // js/caculateNotification.js

    // Add at the modal tab waiting for accept
    let userInfoHTML = `
